...
#[test]
fn varied_unit_computation_1() -> Result<(), String> {
...
#[test]
fn varied_unit_computation_2() -> Result<(), String> {
...
#[test]
fn varied_constant_sumation() -> Result<(), String> {
...
#[test]
fn varied_linner_summation() -> Result<(), String> {
...
#[test]
fn varied_geometric_summation() -> Result<(), String> {
...
#[test]
fn varied_part_of_2() -> Result<(), String> {
    escribir_en_archivo(": next1 dup 2 * ;
    : next2  next1 next1 ;
    : next4  next2 next2 ;
    : mul1 * ;
...
fn varied_digit_to_string() -> Result<(), String> {
